...
public void beforeC() {
		...
		driver.findElement(By.xpath("//input[@id='lastName']")).sendKeys("Jain");
		driver.findElement(By.xpath("//label[contains(.,'Female')]")).click();
		driver.findElement(By.xpath("//input[@id='userNumber']")).sendKeys("abcdefghij");
		Thread.sleep(1000);			
		WebElement ele = driver.findElement(By.xpath("//button[@id='submit']"));	
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView()", ele);
		...
		driver.findElement(By.xpath("//input[@id='lastName']")).sendKeys("Jain");
		driver.findElement(By.xpath("//label[contains(.,'Female')]")).click();
		driver.findElement(By.xpath("//input[@id='userNumber']")).sendKeys("982238");
		Thread.sleep(1000);			
		WebElement ele = driver.findElement(By.xpath("//button[@id='submit']"));	
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].scrollIntoView()", ele);
